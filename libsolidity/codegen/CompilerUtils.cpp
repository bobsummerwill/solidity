...
void CompilerUtils::accessCalldataTail(Type const& _type)
{
	...
	("revertString", m_context.revertString("Invalid calldata offset"))
...
void CompilerUtils::abiDecode(TypePointers const& _typeParameters, bool _fromMemory)
{
	...
	templ("revertString", m_context.revertString("Calldata too large"));
		...
		if (type->category() == Type::Category::Array)
		{
			...
			if (_fromMemory)
			{
				...
				if (arrayType.isDynamicallySized())
				{
					...
					templ("revertStringPointer", m_context.revertString("Invalid data pointer"));
					templ("revertStringStart", m_context.revertString("Invalid data start"));
					templ("revertStringLength", m_context.revertString("Invalid data length"));
			...
			else
			{
				...
				if (calldataType->isDynamicallySized())
				{
					...
					("revertString", "Invalid data offset")
					.render(), {"data_offset"});
					...
					("revertString", "Invalid head pointer")
					...
					("revertString", "Invalid data pointer")
