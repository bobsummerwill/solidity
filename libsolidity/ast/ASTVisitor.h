...
public:
	...
	virtual bool visit(NatspecDocumentation& _node) { return visitNode(_node); }
	...
	virtual void endVisit(NatspecDocumentation& _node) { endVisitNode(_node); }
...
public:
	...
	virtual bool visit(NatspecDocumentation const& _node) { return visitNode(_node); }
	...
	virtual void endVisit(NatspecDocumentation const& _node) { endVisitNode(_node); }
