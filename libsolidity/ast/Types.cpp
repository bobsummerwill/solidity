...
ASTPointer<NatspecDocumentation> FunctionType::documentation() const
{
	auto function = dynamic_cast<NatspecDocumented const*>(m_declaration);
	if (function)
		return function->documentation();

	return ASTPointer<NatspecDocumentation>();
}
