...
/**
 * The Natspec documentation class
 */
class NatspecDocumentation: public ASTNode
{
public:
 ...
 * Abstract class that is added to each AST node that can receive documentation.
 */
class NatspecDocumented
{
public:
	virtual ~NatspecDocumented() = default;
	explicit NatspecDocumented(ASTPointer<NatspecDocumentation> const& _documentation): m_documentation(_documentation) {}

	/// @return A shared pointer of an ASTString.
	/// Can contain a nullptr in which case indicates absence of documentation
	ASTPointer<NatspecDocumentation> const& documentation() const { return m_documentation; }

protected:
	ASTPointer<NatspecDocumentation> m_documentation;
};
 ...
 */
class ContractDefinition: public Declaration, public NatspecDocumented
{
public:
	ContractDefinition(
		int64_t _id,
		SourceLocation const& _location,
		ASTPointer<ASTString> const& _name,
		ASTPointer<NatspecDocumentation> const& _documentation,
		...
		NatspecDocumented(_documentation),
...
class FunctionDefinition: public CallableDeclaration, public NatspecDocumented, public ImplementationOptional
{
public:
	FunctionDefinition(
		int64_t _id,
 ...
 */
class ModifierDefinition: public CallableDeclaration, public NatspecDocumented
{
public:
	ModifierDefinition(
		int64_t _id,
 ...
 */
class EventDefinition: public CallableDeclaration, public NatspecDocumented
{
public:
	EventDefinition(
		int64_t _id,
